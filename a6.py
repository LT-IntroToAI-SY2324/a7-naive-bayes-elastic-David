...
if __name__ == "__main__":
    ...
    print(b.classify('The movie had terrible casting'))
    print(b.classify('I hate how the movie is so horribly good'))
    print(b.classify('This movie is so bad its funny'))
